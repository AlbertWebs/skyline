    ...
    <section class="mainslider" id="mainslider">
        ...
        <div class="rev_slider_wrapper fullwidthbanner-container dark-slider" data-alias="vimeo-hero" style="margin:0px auto;background-color:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
            ...
            <div id="rev_slider_kenburns" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
                <ul>
                    <!-- SLIDE  -->
                    <li data-index="rs-1" data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="{{asset('theme/img/revolution-slider/kenburns/thumb1.jpg')}}" data-rotate="0" data-saveperformance="off" data-title="Ken Burns" data-description="">
                        <!-- MAIN IMAGE -->
                        ...
                        {{-- <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['92','92','92','92']" data-width="none" data-height="none" data-whitespace="nowrap" data-transform_idle="o:1;" data-transform_in="y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;s:2000;e:Power4.easeInOut;" data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;s:1000;e:Power2.easeInOut;" data-mask_in="x:0px;y:[100%];s:inherit;e:inherit;" data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;" data-start="1500" data-splitin="none" data-splitout="none" data-responsive_offset="on" style="z-index: 6; white-space: nowrap; font-size:25px">
                         ...
                         <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0"
                                    ...
                                    style="font-size:25px !important; letter-spacing:normal;  text-align:center !important; margin:0 auto; line-height: 1.5; margin:0 auto !important;">
                                    <span>
                                        <center>
                        ...
                        <!-- LAYER NR. 4 -->
                        <div class="tp-caption" data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['190','190','190','190']" data-width="none" data-height="none" data-whitespace="nowrap" data-transform_idle="o:1;" data-transform_hover="o:1;rX:0;rY:0;rZ:0;z:0;s:300;e:Power1.easeInOut;" data-style_hover="c:rgba(255, 255, 255, 1.00);bc:rgba(255, 255, 255, 1.00);" data-transform_in="y:100px;sX:1;sY:1;opacity:0;s:2000;e:Power3.easeInOut;" data-transform_out="y:50px;opacity:0;s:1000;e:Power2.easeInOut;" data-start="750" data-splitin="none" data-splitout="none" data-responsive_offset="on" data-responsive="off" style="z-index: 11; white-space: nowrap;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;"><a style="color:#23527c" href="#about" class="custom-button slider-button scroll-to-target">learn more about us</a></div>
                    </li>

                    <!-- SLIDE  -->
                    <li data-index="rs-2" data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="{{asset('theme/img/revolution-slider/kenburns/thumb1.jpg')}}" data-rotate="0" data-saveperformance="off" data-title="Ken Burns" data-description="">
                        <!-- MAIN IMAGE -->
                        <img alt="" src="{{asset('theme/img/revolution-slider/kenburns/kenburns1.jpg')}}" data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="180" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        ...
                        <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0"
                             ...
                             style="z-index: 5; white-space: nowrap;">WE ARE Skyline PR
                        </div>
                        ...
                        <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0"
                                    ...
                                    <span>
                                        <center>
                                            A brand is an already created perception of an organization that is achieved through intentional communication.
                                        </center>
                                    </span>
                        </div>
                     ...
                     <!-- SLIDE  -->
                     <li data-index="rs-3" data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="{{asset('theme/img/revolution-slider/kenburns/thumb1.jpg')}}" data-rotate="0" data-saveperformance="off" data-title="Ken Burns" data-description="">
                        <!-- MAIN IMAGE -->
                        <img alt="" src="{{asset('theme/img/revolution-slider/kenburns/kenburns1.jpg')}}" data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="180" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        ...
                        <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0"
                                    ...
                                    <span>
                                        <center>
                                            A brand isn’t manufactured overnight - it's cultivated a period of  time with consistency and in intentional communication
                                        </center>
                                    </span>
                        </div>
                    ...
                    <li data-index="rs-4" data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="{{asset('theme/img/revolution-slider/kenburns/thumb1.jpg')}}" data-rotate="0" data-saveperformance="off" data-title="Ken Burns" data-description="">
                     ...
                     <!-- SLIDE  -->
                     <li data-index="rs-5" data-transition="zoomin" data-slotamount="7" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-thumb="{{asset('theme/img/revolution-slider/kenburns/thumb1.jpg')}}" data-rotate="0" data-saveperformance="off" data-title="Ken Burns" data-description="">
                        <!-- MAIN IMAGE -->
                        <img alt="" src="{{asset('theme/img/revolution-slider/kenburns/kenburns1.jpg')}}" data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="180" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                        <!-- LAYERS -->
                        ...
                        <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0"
                                    ...
                                    <span>
                                        <center>
                                            Data alone cannot tell stories. Humanize your stories.<br>Combine with visualization and narrative. Tell the story behind the data
                                        </center>
                                    </span>
                        </div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-6 about-left-side">
                  ...
                  in Africa.
                        ...
                        <div id="visionT" class="tab-pane fade">
                            <p>
                                To positively impact the economy of businesses and organizations in Africa
                                through corporate branding and positioning thus enhancing visibility and publicity
                                of organizations (strategic communications). This allows expansion of the existing
                                markets and finding new ones. Introducing new products thus building visibility
                                and awareness of the organizations to the target publics e.g., launching new
